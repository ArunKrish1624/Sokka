/*-----------------------------------------------------------------------------------
    ...
    Template Name: sokka - eCommerce HTML Template
    URI: site.com 
    Description: sokka is a clean, modern, and elegant fashion e-commerce HTML template. It allows you to easily create a well-designed e-commerce website that is easily customizable to fit your brand colors and requirements.
    Author: Pixelfit
...
(function($) {
    ...
    function mainMenu() {
        ...
        navMenu = $('.sokka-nav-menu'),
        navMenuLi = $('.sokka-nav-menu ul li ul li'),
    ...
    function offCanvas(){
        ...
        $(".offcanvas__overlay").on('click', function (e) {
            ...
            $(".sokka-nav-menu").removeClass("menu-on");
    ...
    if ($('.hero-slider-one').length) {
        ...
        $('.hero-slider-one').slick({
            ...
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<div class="prev"><i class="fa-solid fa-arrow-left"></i><img src="assets/images/hero/arrow-bg.png" alt=""></div>',
            nextArrow: '<div class="next"><img src="assets/images/hero/arrow-bg.png" alt=""><i class="fa-solid fa-arrow-right"></i></div>',
            responsive: [
                {
                    breakpoint: 1200,
                    settings: {
